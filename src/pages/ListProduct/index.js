  ...
  return (
    ...
    <div className='animate__animated animate__fadeInRight'>
        <div className="card bg-white rounded-none top-7 grid  ">
          <div role="tablist" className="tabs tabs-bordered mt-4  " style={{borderColor:'#f89a88'}}>
            ...
            <input type="radio" name="my_tabs_1" role="tab" className="tab w-2/5 border-b-2"  aria-label="Đang bán" 
