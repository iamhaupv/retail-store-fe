    ...
    <div className='w-1130 '>   
        <div className="card bg-white rounded-none left-14 top-7 grid  ">
          <div role="tablist" className="tabs tabs-bordered ">
            <input type="radio" name="my_tabs_1" role="tab" className="tab " aria-label="Tất cả" />
            <div role="tabpanel" className="tab-content p-10"> <ListProductTable/>  </div>

            <input type="radio" name="my_tabs_1" role="tab" className="tab" aria-label="Đang bán" defaultChecked />
            <div role="tabpanel" className="tab-content p-10"> <ListProductTable/> </div>
