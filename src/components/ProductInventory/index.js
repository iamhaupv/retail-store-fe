        ...
        products.map((product) => {
          return (
            <tr key={product._id} className="hover:bg-slate-100">
              ...
              <td>
                <div className="font-bold">{product.invoiceNumber || "P0212421"}</div>
              </td>
              <td>
                <div className="flex items-center gap-3">
                  <div className="avatar">
                    <div className="mask rounded h-12 w-12">
                      <img
                        src={product.image || "https://img.daisyui.com/images/profile/demo/2@94.webp"}
                        alt={product.name || "Avatar"}
                      />
                    </div>
                  </div>
                  <div>
                    <div className="font-bold">{product.name || "Áo polo nam Galvin cổ dệt bo len"}</div>
                  </div>
                </div>
              </td>
              <td>
              ...
              <th>
                <button className="btn btn-ghost btn-xs">{product.quantity || "900"}</button>
              </th>
              <th>
                <button
