...
//     // Tìm kiếm các gợi ý dựa trên giá trị nhập vào
...
//     setSuggestions([]);
//     onChange(suggestion); // Truyền đối tượng suggestion lên component cha
//   };
...
//         <ul className="absolute border border-gray-300 bg-white w-full mt-1 rounded">
